...
@section('content')
    ...
    <section class="drop_slow1 laptop_respond dark:bg-sky-800">
        <div class="grid max-w-screen-xl py-1 px-4 md:px-4 lg:mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:px-0 lg:grid-cols-12">
            ...
            <div class="mt-1 lg:mt-0 lg:col-span-5 lg:flex">
                @if (!empty($room))
                    <img class="w-full object-cover rounded-t-lg" src="/Uploads/{{$room->thumbnail}}"
                alt="" />
                @endif
    ...
    <div class="room-booking  ">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form action="/room/detial/store" method="POST">
                        ...
                        <div class="p-5">
                            <div class="mb-5">
                                <label for="room"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Room selected <span
                                        class="text-rose-700">*</span></label>
                                <input type="text" value="{{ old('room', $room->id ?? '') }}" id="room" name="room"
                                    class="hidden" required />
                                <input type="text" name="ka" value="{{ old('ka', $room->room_name  ?? '') }}" readonly
                            ...
                            <div class="mb-5">
                                <label for="id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Staff ID <span
                                        class="text-rose-600">*</span></label>
                                <input type="text" readonly value="{{ old('staff_id', Auth::user()->id_card ?? '') }}"
                                    id="id" name="staff_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required />
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <select id="department" readonly name="staff_department"
                                    ...
                                    <option selected value="{{ old('staff_department', Auth::user()->department ?? '') }}">
                            ...
                            <div class="mb-5">
                                <label for="meeting_type"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Meeting Type <span
                                        class="text-rose-600">*</span></label>
                                <div class="mx-auto grid grid-cols-2 gap-4">
                                    <div class="flex items-center mb-4">
                                        <input id="meeting" checked type="radio" value="Meeting" name="meeting_type"
                            ...
                            <div class="mb-5">
                                <label for="description"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Meeting or Training
                                    Title </label>
                            ...
                            <div class="mb-5 grid grid-cols-2 gap-4">
                                <div>
                                    <label for="from_date"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">From Date <span
                                            class="text-rose-600">*</span></label>
                                ...
                                <div>
                                    <label for="to_date"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">To Date <span
                                            class="text-rose-600">*</span></label>
                            ...
                            <div class="mb-5 grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input onchange="validation_data()" type="time" id="start_time" name="start_time"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required />
                                </div>
                                <div>
                                    <label for="end_time"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">End Time <span
                                            class="text-rose-600">*</span></label>
                                    <input onchange="validation_data()" type="time" id="end_time" name="end_time"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required />
                                </div>
                            </div>
        ...
        <section class="calendar drop_slow1 laptop_respond bg-white   flex  max-w-screen-xl px-4  py-2 mx-auto lg:gap-8 xl:gap-0 lg:py-4  ">
            ...
            <div
                class=" w-full flex flex-col py-1 px-4 md:px-4 lg:mx-auto lg:gap-8 xl:gap-0 lg:pt-0 pb-4 lg:px-0">
                <header
                    class="flex items-center justify-between  border-gray-200 px-1 lg:px-0 pt-0 pb-4 lg:flex-none">
                    ...
                    <div class="flex bg-gray-200 text-xs leading-6 text-gray-700 lg:flex-auto">
                        ...
                        <div class=" w-full grid  lg:grid grid-cols-7  lg:grid-cols-7 lg:grid-rows-5 lg:gap-px">
                            @foreach ($days as $day)
                                ...
                                @if ( today() == $day )
                                    <div class=" day relative bg-white px-3 py-2" data-modal-target="default-modal2" data-modal-toggle="default-modal2" onclick="show_schedule({{$day_click}},{{$month_click}},{{$year_click}})">
                                        <time datetime="2022-01-12" class="flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 font-semibold text-white">{{\Carbon\Carbon::parse(today() )->format('d ')}}</time>
                                        @if($qty_booked_a_day != 0)
                                        <ol class="mt-2">
                                            <li>
                                                <div class="group flex">
                                                    <p class="date_for_pc flex-auto truncate font-medium text-rose-600 group-hover:text-indigo-600">{{$qty_booked_a_day}} Meeting</p>
                                                    <p class="date_for_mobile flex-auto truncate font-sm text-rose-600 group-hover:text-indigo-600">{{$qty_booked_a_day}}*</p>
                                ...
                                @else
                                <div class="day relative bg-gray-50 px-3 py-2" data-modal-target="default-modal2" data-modal-toggle="default-modal2" onclick="show_schedule({{$day_click}},{{$month_click}},{{$year_click}})">
                                    <time datetime="2022-01-12" class="day relative bg-gray-50 text-gray-500">{{\Carbon\Carbon::parse($day)->format('d')}}</time>
                                    @if($qty_booked_a_day != 0)
                                    <ol class="mt-2">
                                    <li>
                                        <div class="group flex">
