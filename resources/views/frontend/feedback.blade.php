        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-sky-600 to-cyan-500 px-6 py-6 text-white">
                ...
                <p class="mt-2 text-sm text-sky-100">
                    Report booking issues, room problems, or suggestions directly to the admin team.
                </p>
            </div>
            ...
            <div class="px-6 py-5 bg-sky-50 dark:bg-gray-900 border-b border-sky-100 dark:border-gray-700">
                ...
                <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-300 space-y-1">
                    ...
                    <li>Do not include unnecessary private or sensitive information.</li>
                    <li>Your feedback will be reviewed by admin only.</li>
                </ul>
            </div>
            ...
            <form action="/feedback/submit" method="POST" class="p-6 space-y-5">
                ...
                <div class="rounded-2xl bg-yellow-50 border border-yellow-200 p-4 text-sm text-yellow-800 dark:bg-yellow-500/10 dark:border-yellow-500/30 dark:text-yellow-200">
                    Your feedback will only be visible to the admin team.
                    Other users cannot see your message.
                </div>
