            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    <form action="/room/cancel" method="post" onsubmit="disableSubmitButton(this)">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Enter Reason code to cancel.
                        </h3>
                    ...
                    <table class="standard-table  table w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col"
                                    class="hover_td_left bg-gray-50 dark:bg-gray-700 px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                    Meeting Room </th>
                                ...
                                <th scope="col"
                                    class="hover_td  bg-gray-50 dark:bg-gray-700 px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @foreach ($data as $item)
                                @if (Auth::user()->id == $item->created_by_id)
                                    <tr class="border-b dark:border-gray-700 selected">
                                                       <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">{{ $state+1 }}</td>
                                        <th scope="row"
                                            class="hover_td_left selected px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3 font-medium text-gray-900 whitespace-nowrap ">
                                            {{ $item->room }}</th>
                                        ...
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                            {{ \Carbon\Carbon::parse($item->start_time)->format('h:i A') }}</td>
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                        ...
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                            ...
                                            @else
                                                <span
                                                    class="inline-flex items-center bg-amber-100 text-amber-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                        ...
                                        <td class="hover_td selected px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                            @if (Auth::user()->id == $item->created_by_id && $item->status == 1)
                                                <button type="button" onclick="delete_id({{ $item->id }})"
                                                    data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                                    class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Cancel</button>
                                            @endif
                                        </td>
                                ...
                                @else
                                    <tr class="border-b dark:border-gray-700 ">
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">{{ $state+1 }}</td>
                                        <th scope="row"
                                            class="hover_td_left px-3 bg-gray-50 dark:bg-gray-700 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $item->room }}</th>
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">{{ $item->title }}</td>
                                        ...
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                            {{ \Carbon\Carbon::parse($item->end_time)->format('h:i A') }}</td>
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">{{ $item->meeting_type }}
                                        </td>
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                            {{ \Carbon\Carbon::parse($item->created_at)->format('d F Y') }}</td>
                                        <td class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3">
                                        ...
                                        <td
                                            ...
                                            @if ($item->created_by_id == Auth::user()->id || Auth::user()->role == 'admin')
                                                <button type="button" onclick="delete_id({{ $item->id }})"
                                                    data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                                    class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-4 py-1 text-center me-2 mb-2 md:px-5 md:py-2.5">Cancel</button>
                                            @endif
                                        </td>
                            ...
                            @if ($state == 0)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        class="px-3 py-3 md:px-4 md:py-3 lg:px-4 lg:py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        No Bookng Data</th>
        ...
        <div class="p-2 w-full flex justify-between">
            ...
            <div class="max-w-full flex justify-between ">
                ...
                <div class="pagination_by_search defualt item-center flex ">
                    <span class="text-gray-900 whitespace-nowrap dark:text-white">Total Meeting : {{$state}}</span>
                    &ensp;
                    &ensp;
                    &ensp;
                    &ensp;
                    &ensp;
                    &ensp;
                    <span class="text-gray-900 whitespace-nowrap dark:text-white">Canceled Meeting : {{$cancel}}</span>
                </div>
